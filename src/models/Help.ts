...
export class Help {
  ...
  static getCommandDescription(command: string[], fs: FileSystem): string {
    if (command.length > 1) {
      return `<p><span class="text-red-500">Error</span>: command [help] requires exactly 1 argument</p>`
